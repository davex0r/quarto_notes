...
[Quarto](quarto.org) is a 

> An open-source scientific and technical publishing system

based on markdown that allows for equations and code to be easily embedded into posts. This [guide](https://quarto.org/docs/guide/) provides an excellent overview of setting up a quarto notes site and how to author individual posts as well as the basics of markdown and . I referred to this to set up the website, the different notes sections, the main index, and the RSS feed.  This site is separately hosted from the my main website, which I wrote mostly in html and is hosted on github pages with a custom domain.  
