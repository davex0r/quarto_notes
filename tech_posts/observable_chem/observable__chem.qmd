...
---
This is a short note which connects how well chosen changes to the chemical kinetics in a simple system can manifest mathematically as either altering the projections onto a constant set of basis functions, or altering the basis functions while maintaining the projection.
$$
\Large
\ce{a<=>[{\lambda}][{\nu}]b}
$$
